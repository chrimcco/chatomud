    ...
    module Rooms
      ...
      module FurnituresContainer
        ...
        def accept_character(furniture_controller, remove_from_containing_room)
          furniture_controller.appear_in(self, @room, remove_from_containing_room)
        end
        ...
        def list_accommodations(character_controller = nil)
          ...
          return "There are no pieces of furniture here." unless accommodation_furniture_controllers.count > 0
