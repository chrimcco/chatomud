      ...
      module Inventory
        ...
        module Holder
          ...
          def can_hold_right_hand?(item_controller)
            held_two_handed = find_item_controller_by_slot(:w2hands)
            if held_two_handed
              return held_two_handed == item_controller
            end

            return false if find_item_controller_by_slot(:rhand)

            wielded_right_hand = find_item_controller_by_slot(:wrhand)
            return !wielded_right_hand || wielded_right_hand == item_controller
          end
          ...
          def can_hold_left_hand?(item_controller)
            ...
            return !wielded_left_hand || wielded_left_hand == item_controller
          end
