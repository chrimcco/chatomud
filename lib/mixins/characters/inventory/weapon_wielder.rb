      ...
      module Inventory
        ...
        module WeaponWielder
          ...
          def can_wield_two_handed?(item_controller)
            ...
            return carried.count == 0 || (carried.count == 1 && carried[0] == item_controller)
          end
          ...
          def can_wield_right_hand?(item_controller)
            ...
            return !held_right_hand || held_right_hand == item_controller
          end
          ...
          def can_wield_left_hand?(item_controller)
            ...
            return !held_left_hand || held_left_hand == item_controller
          end
