      ...
      module Inventory
        ...
        module RangedWeaponWielder
          ...
          def ranged_weapon_controllers(where, loaded)
            send("ranged_weapon_controllers_#{where.to_s}", loaded)
          end
          ...
          def matches_loaded_preference(ranged_weapon_controller, loaded)
            ...
            return ranged_weapon_controller.weapon_stat_controller.ranged_stat_controller.inventory_controller.is_loaded? == loaded
          end
