    ...
    module Outfitters
      ...
      class CharactersOutfitter
        ...
        def outfit(character_controller, item_template_codes)
          item_template_codes.keys.each do |wloc_key|
            ...
            case entry.class.name.to_sym
              ...
              when :Symbol
                item_controller = @server.items_spawner.spawn_item(ItemTemplate.find_by_code(entry), {}, nil, character_controller.inventory_controller)
            end
