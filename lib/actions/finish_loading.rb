    ...
    class FinishLoading < BaseAction
      ...
      def exec
        ...
        case from
          ...
          when :from_quiver
            missile_controller = handle_spawned_item(missile_controller, 1, ranged_weapon_controller.weapon_stat_controller.ranged_stat_controller.inventory_controller)
          else
