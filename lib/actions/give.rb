  ...
  module Actions
    ...
    class Give < BaseAction
      ...
      def exec
        ...
        unless check_character_can_hold(receiver_character_controller, item_controller, nil)
        ...
        if amount
          ...
          new_item_controller = handle_spawned_item(item_controller, amount, receiver_character_controller.inventory_controller)
