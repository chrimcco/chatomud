  ...
  module Actions
    ...
    class Aim < BaseAction
      ...
      def exec
        ...
        target_info = room_controller.target_in_line_of_sight(direction, 3, target)

        return unless check_target_present(target_info[:target], "You do not see that individual #{direction}ward.")
