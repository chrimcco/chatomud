  ...
  module Actions
    ...
    class Unload < BaseAction
      ...
      def exec
        ...
        return unless check_can_load_or_unload(wielded_ranged_weapon_controller, missile_controller, 'unload')
        
        quiver_controllers = @character_controller.inventory_controller.quiver_controllers(:worn)

        unless check_count_is_positive(quiver_controllers, nil)
          room_controller.emit_action_echo('unload', { emitter: @character_controller, destination: :hand })
        ...
        room_controller.emit_action_echo('unload', { emitter: @character_controller, destination: quiver_controller })
