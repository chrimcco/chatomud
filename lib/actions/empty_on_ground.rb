  ...
  module Actions
    ...
    class EmptyOnGround < BaseAction
      ...
      def exec
        ...
        if check_is_closable(item_controller.inventory_controller, nil)
          return unless check_must_be_open(item_controller.inventory_controller.lid_controller, "#{item_controller.short_desc} is closed.")
        end
