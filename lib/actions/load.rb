  ...
  module Actions
    ...
    class Load < BaseAction
      ...
      def exec
        ...
        if check_count_is_positive(held_missile_controllers, nil)
        ...
        return unless check_can_load_or_unload(@wielded_ranged_weapon_controller, missile_controller, 'load')
